...
try {
    ...
    error_log("Company coupons page error: " . $e->getMessage());
}
?>
...
<div class="company-coupons-container">
    <div class="page-header mb-4">
        <div>
            <h2><i class="bi bi-ticket-perforated"></i> Manage Coupons</h2>
            <p class="text-muted mb-0">Create and manage discount coupons for your company</p>
        </div>
...
document.getElementById('save-coupon-btn').addEventListener('click', async function() {
    ...
    try {
        const response = await fetch('/api/company/manage_coupons.php', {
            method: 'POST',
            body: formData
        });
